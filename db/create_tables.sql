...
-- INSERT INTO borrowers (name, location, long, lat, image) VALUES 
-- ('Litia','Samoa', -13.583333, -172.333333, 2606639),
-- ('Sulma Yaneth','El Salvador', 13.833333, -88.916667, 2608011),
-- ('Gladys','Kenya', 1.0, 38.0, 2606638),
-- ('Dorothy','Cameroon', 6.0, 12.0, 2606636),
-- ('Joanina','Timor-Leste', -8.833333, 125.75, 2606634),
-- ('Panfilo','Bolivia', -17.0, -65.0, 2608007),
-- ('Ivona','Vaovai', -14.016667, -171.65, 2606463),
-- ('Eleitino','Samoa', -13.583333, -172.333333,2606633),
-- ('Elber','Bogotà', 4.0, -72, 2608012),
-- ('Trephina Lum','Cameroon', 6.0, 12.0, 2606628),
-- ('Virginia','Kenya', 1.0, 38.0, 2606629),
-- ('Fuafanua','Samoa', -13.583333, -172.333333, 2606626),
-- ('Santusa','Peru', -10.0, -76.0, 2608009),
-- ('Sergio De Jesús','El Salvador', 13.833333, -88.916667, 2608006),
-- ('Maritza Esperanza','El Salvador', 13.833333, -88.916667, 2325796),
-- ('Robert','Kenya', 0.283333, 34.75,2606619),
-- ('John Suh','Cameroon', 6.0, 12.0, 2606617),
-- ('Faru 1 Group','Tanzania', -6.8, 39.283333,2606623),
-- ('Riu','Timor-Leste', -8.833333, 125.75,2606611),
-- ('Lasha','Georgia', 42.0, 43.5,2606610);
